...
test('shimmed', function (t) {
	...
	t.test('bad string/this value', { skip: !supportsStrictMode }, function (st) {
		st['throws'](function () { return String.prototype.trimRight.call(undefined, 'a'); }, TypeError, 'undefined is not an object');
		st['throws'](function () { return String.prototype.trimRight.call(null, 'a'); }, TypeError, 'null is not an object');
		st.end();
	});
